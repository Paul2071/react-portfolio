  ...
  return (
    <div name="home" className='w-full h-screen bg-[#535657]'>
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <p className='text-[#3cf73c] py-4 max-w-[700px] text-justify'>A member of the most recent School of Code cohort, I look forward to continuing my journey in tech and learning new skills. At the minute, I am working on cementing my understanding of React and CSS and plan to broaden my knowledge of backend to  enable building fullstack applications.   </p>
            <div>
