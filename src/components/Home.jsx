  ...
  return (
    <div name="home" className='w-full h-screen bg-slate-600'>
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <p className='text-[#8892b0] py-4 max-w-[700px]'>Previously a Bookseller for 11 years, currently I am focused on using my problem solving skills and passion for learning to create full-stack applications.  </p>
            <div>
